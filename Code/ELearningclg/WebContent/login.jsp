...
<title>e-learning</title>
 ...
 <link rel="stylesheet" href="css/normalize.css">
    ...
    <body>
        ...
        <div id="top" class="starter_container2" style="">
            <div class="follow_container">
            
                <div class="col-md-6 col-md-offset-3">
                 <div style="background-color: #292929bd; background-size:500px;margin-top: 5px;">
                <br>
                <form name="Reg" action="LoginController"  method="post">
				...
				<fieldset>	
					...
					<tr><section>
						<label class="input">
							<i class="icon-append icon-lock"></i>
							<td style="color: white;">Department</td><td> <select name="dept">
				...
				<footer>
					...
					<br><a href="forgotpassword.jsp" style="color:white;">Forget Password</a> <br>
					<%
         						 ...
         						 %>
										<span style="color:red;background-color:white;"><%=msg %></span>
