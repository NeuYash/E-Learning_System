...
.starter_container {
    ...
    min-width: 100%;
    height: 100%;
    background: url('../images/group3.jpg') no-repeat top;
...
.starter_container1 {
    ...
    min-width: 100%;
    height: 100%;
    background: url('../images/group12.jpg') no-repeat top;
    background-size: cover;
    text-align: center;
    background-position: center;  
}
...
.starter_container3 {
    ...
    min-width: 100%;
    height: 100%;
    background: url('../images/new5.jpg') no-repeat top;
    background-size: cover;
    text-align: center;
    background-position: center;  
}
