...
<body>
    ...
    <body>
        ...
        <div id="top" class="starter_container4">
            <div class="follow_container">
            
                <div class="col-md-6 col-md-offset-3">
                 <div style="background-color: #4a424280; background-size:500px">
                <br>
                   <form name="Reg" action="OwnerLoginController" class="sky-form" method="post">
				...
				<fieldset>	
					...
					<tr><section>
						<label class="input">
							<i class="icon-append icon-lock"></i>
							<td style="color: white;"></td><td> <label style="margin-left: -150px; margin-top: 16px;  color: snow;font-family: serif;font-size: 16px;">Department:</label>
