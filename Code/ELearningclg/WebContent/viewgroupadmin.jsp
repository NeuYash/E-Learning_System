                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="selectcategories3.jsp">BACK</a></li>
...
<!-- 
          <div class="panel panel-default">
            ...
            <div class="panel-body"><a  href="localhost:8086/GroupDataSharing/viewgroup.jsp"><span style="color: #0000ffd9"><strong>GroupShareTech.com</strong></span></a></div>
          </div> -->
