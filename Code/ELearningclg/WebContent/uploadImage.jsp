                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="#logout.jsp">LOGOUT</a></li>
        ...
        <div id="top" class="starter_container1 bg">
            <div class="follow_container">
               <form action="UploadImageController" method="post" enctype="multipart/form-data">
				<div class='resp_code align='center'' style=" box-shadow: 0 0 2em #041d19;
    background-color: #f5f5f5a6;
    background-color: rgba(241, 231, 233, black);
    margin-top: 72px;
    width: 531px;
    margin-left: 426px;">
				...
				<br><br><br>
					<input type="file" name="file" id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple style="
    margin-top: -2%;
    margin-left: 2%;
" />
					<label for="file-1" style="
    margin-top: 3%;
    margin-bottom: `;
    margin-bottom: 1%;
"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Choose a file&hellip;</span></label>
					<br>
					<input type="submit" value="Upload Image" style="
    margin-bottom: 4%;
    /* margin-top: 3%; */
">
					</table>
