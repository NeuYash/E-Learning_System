...
.tr1{
    ...
    border-style: double;margin-left: 30%; border:2px; 
    width: 100%;}
body {
	background-image: url(images/Twitter-logo1.jpg);
	background-size: cover;
}
.td1{width: 10%;padding: 5px;
}
.btn1:hover{
margin-top: 0px;
    margin-bottom: 10px;
...
<body class="three-col logged-out ms-windows"
	data-fouc-class-names="swift-loading" dir="ltr" style="background-image: url(images/ed16.jpg); background-repeat: no-repeat; background-size:cover;height:700px;">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class=" color_animation" href="creategroup.jsp">BACK</a></li> 
	...
	<% 
        ...
        System.out.println("ala ka"+dept);
		List<userModel> userlist = DataAccessLayer.getAvailableUsers(userid);
		 System.out.println(" deepartment"+dept);
	...
	%>
       <%! private void KNN() {
    		...
    		String dept[] = {"IT","CS","ENTC","Electrical","Mech","Civil"};
	...
	<br><br><br><br><br><br>
	<span style=" margin-left: 475px;padding:10px; font-family: sans-serif; font-size: 27px; background-color: #dc7b22b0; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	Group Name&nbsp;&nbsp;:&nbsp;&nbsp;<%out.println(gname);%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="hidden" name="gname" value="<%=gname%>" disabled="disabled" style=" border: none; "></span>

	<br><br><br>
	<div style="background-color: #ffc0cb61; width: 75%; height: 100%; margin-left: 160px; border-radius: 25px; padding-top: 10px;padding-right: 70px;">
	<form action="CreateGroupController" method="post">
	<input type="submit" value="Create Group" class="btn1" >
	
	</form>
	
	<table style="margin: 33px 10px 10px 75px;background-color:white; ">
		
		<%
			for (userModel u : userlist) {
		if (u.isFollowing())
				{
				 BufferedImage bimg = DataAccessLayer.getImg1(u.getId());
	...
	<tr class="tr1">
		...
		<% if(dept.equals(u.getdept())) {%>
			 <td class="td1"><img src="data:img/jpg;base64, <%=b68%>"  style="height: 100px;
    width: 100px;    background-color: #753f3f;    border: 3px solid #1c74cc;
    border-radius: 20px;    margin-left:65px; "> </td> 
       
			<td class="td1"><%=u.getFirstName()%>&nbsp;&nbsp;<%=u.getLastName()%></td>
			<td class="td1"><%=u.getEmailID()%></td>
			<td class="td1"><%=u.getdept()%></td>
			<input type="hidden" name="userId" value="<%=userid%>" /> 
			<input type="hidden" name="profileId" value="<%=u.getId() %>">
			<td class="td1"><input type="submit" style="height: 25px;font-size: small; border-radius:5px; width: 80px; color: white; background-color: #1da0f0;" value="REMOVE"></td>
		   <%} %>
		    </form></tr>
    ...
    border-radius: 20px;    margin-left:65px; "> </td> 
			...
			<input type="hidden" name="userId" value="<%=userid%>" /> 
			<input type="hidden" name="profileId" value="<%=u.getId() %>">
			<td class="td1"><input type="submit" style="height: 25px;font-size: small; border-radius:5px; width: 80px; color: white; background-color: #1da0f0;" value="ADD"></td>
			<%} %>
			</form>
		</tr>
		<%
