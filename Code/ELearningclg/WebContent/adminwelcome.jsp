                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                           <!--  <li><a class="navactive color_animation" href="creategroup.jsp">CREATE-GROUP</a></li> -->
                            ...
                            <!--  <li><a class="navactive color_animation" href="examples/Report.jsp"> Dashboard</a></li> -->
                             <li><a class="navactive color_animation" href="SelectCategory1.jsp">Upload Data</a></li>
