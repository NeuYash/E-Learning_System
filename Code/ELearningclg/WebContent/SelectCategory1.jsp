...
int userid = Integer.parseInt(session.getAttribute("uid").toString());
 List<String> catList = DataAccessLayer.getAllGroup1();
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
               ...
               <div class="panel panel-default" style=" background-color:skyblue; margin-top: 140px; height: 66%;opacity: 0.8;"">
	            ...
	            <strong style=" width:30px; color:black; font-size:20px;font-family:"Times New Roman", Times, serif; ">SELECT YOUR GROUP FOR OPRATION! </strong>
				</div>
			    ...
			    <div class="row">
				 ...
				 <form action="CategoryController1" method="post">
		<div id="main">
			...
			<table>
				<tr>
					<td><div class="select" style="margin-left: 600px; margin-top: -35px;">
				...
				<tr>
					<td align="center"><input type="submit" name="submit"
						value="SUBMIT" style="margin-left: 600px; margin-top: 15px; background-color: #0000009e;    font-size: 14px;width:10vw "></td>
				</tr>
				<tr></tr>
