...
<body style="width: 100%; height: 100%; background-image: url(images/ed9.jpg); background-repeat: no-repeat; background-size:cover;">
			...
			<div id="content">
				...
				<div class="content_item" style="text-align: justify; width: 900px">
					...
					<div class="contentdiv">
						...
						<center>
							<h1>
								<strong style="color:white;">File Information</strong>
							</h1>
								...
								<table>
									...
									<tbody>
										...
										System.out.println("group name="+cname);
											...
											/* ArrayList<FileInfomation> al = Redundancy_remove.getFileDetailsList(uid,cname); */
                                            String uname=DataAccessLayer.getusername(uid);
											Iterator<FileInfomation> itr = al.iterator();
											//traversing elements of ArrayList object 
											%>
										<H2 style="background-color:white;">USER NAME:<%=uname%> </H2>
											<% while (itr.hasNext()) {

												fd = itr.next();
										%>
										
										<form action="ECCSignature" method="post">
										<tr>
											...
											<td><input type="hidden" name="fid" value="<%=fd.getFid()%>">
												<input type="hidden" name="cname" value="<%=fd.getCatname()%>">
												<input type="hidden" name="filename" value="<%=fd.getFilename()%>"> 
												 <input	type="hidden" name="Uid" value="<%=fd.getUid()%>"> 
												<input type="submit" name="download" value="Download"></td>
